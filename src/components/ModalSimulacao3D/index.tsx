...
import styles from './ModalSimulacao3D.module.css'

interface ModalSimulacao3DProps {
  isOpen: boolean
  onClose: () => void
}
...
export const ModalSimulacao3D: React.FC<ModalSimulacao3DProps> = ({ isOpen, onClose }) => {
  ...
  return (
    <>
      <InlineModal3D isOpen={isOpen} onClose={onClose} className={`${styles.simulacaoModal} ${isExpanding ? styles.expanding : ''}`}>
        ...
        <div className={styles.rightSection}>
          <div className={styles.visualContainer}>
            <img
              ...
              alt={t('imageAlt')}
              className={styles.simulacaoVisual}
            />
